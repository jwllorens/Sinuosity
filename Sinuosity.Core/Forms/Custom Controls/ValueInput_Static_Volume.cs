...
{
    [ToolboxItem(true)]
    public class ValueInput_Static_Volume : Control
    {
        ...
        public ValueInput_Static_Volume()
        {
            textBox = new TextBox
            {
            ...
            if (!string.IsNullOrEmpty(unitString) && Units.GetUnits<UnitVolume>().TryGetValue(unitString, out UnitVolume value))
            {
                currentUnit = value;
            }
            else
