...
{
    [ToolboxItem(true)]
    public class ValueInput_Variable_Angle : Control
    {
        ...
        private UnitAngle[] availableUnits;
        ...
        public ValueInput_Variable_Angle()
        {
            textBox = new TextBox
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            currentUnit = (UnitAngle)comboBox.SelectedItem;
        }
        ...
        {
            get => !DesignMode ? (UnitAngle)comboBox.SelectedItem : null;
            set => SetUnit(value);
        }
        public void SetUnit(UnitAngle unit)
        {
            ...
            UnitAngle foundUnit = availableUnits.FirstOrDefault(u => u.ToString() == unit.ToString());
            if (foundUnit != null)
            {
                suppressSelectedIndexChanged = true;
        ...
        private void UpdateAvailableUnits()
        {
            ...
            {
                availableUnits = Units.AngleUnits.Values.ToArray();
            }
            else
            {
                availableUnits = Units.AngleUnits.Values
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                UnitAngle newUnit = comboBox.SelectedItem as UnitAngle;
                ...
                {
                    decimal? convertedValue = Units.ConvertAngle(valueToConvert.Value, currentUnit, newUnit);
