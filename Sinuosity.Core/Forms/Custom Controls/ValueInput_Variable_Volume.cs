...
{
    [ToolboxItem(true)]
    public class ValueInput_Variable_Volume : Control
    {
        ...
        private UnitVolume currentUnit = null;
        private UnitVolume[] availableUnits;
        ...
        public ValueInput_Variable_Volume()
        {
            textBox = new TextBox
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            currentUnit = (UnitVolume)comboBox.SelectedItem;
        }
        ...
        {
            get => !DesignMode ? (UnitVolume)comboBox.SelectedItem : null;
            set => SetUnit(value);
        }
        public void SetUnit(UnitVolume unit)
        {
            ...
            UnitVolume foundUnit = availableUnits.FirstOrDefault(u => u.ToString() == unit.ToString());
            if (foundUnit != null)
            {
                suppressSelectedIndexChanged = true;
        ...
        private void UpdateAvailableUnits()
        {
            ...
            {
                availableUnits = Units.VolumeUnits.Values.ToArray();
            }
            else
            {
                availableUnits = Units.VolumeUnits.Values
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                UnitVolume newUnit = comboBox.SelectedItem as UnitVolume;
                ...
                {
                    decimal? convertedValue = Units.ConvertVolume(valueToConvert.Value, currentUnit, newUnit);
