...
{
    [ToolboxItem(true)]
    public class ValueInput_Variable_Length : Control
    {
        ...
        private UnitLength currentUnit = null;
        private UnitLength[] availableUnits;
        ...
        public ValueInput_Variable_Length()
        {
            textBox = new TextBox
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            currentUnit = (UnitLength)comboBox.SelectedItem;
        }
        ...
        {
            get => !DesignMode ? (UnitLength)comboBox.SelectedItem : null;
            set => SetUnit(value);
        }
        public void SetUnit(UnitLength unit)
        {
            ...
            UnitLength foundUnit = availableUnits.FirstOrDefault(u => u.ToString() == unit.ToString());
            if (foundUnit != null)
            {
                suppressSelectedIndexChanged = true;
        ...
        private void UpdateAvailableUnits()
        {
            ...
            {
                availableUnits = Units.LengthUnits.Values.ToArray();
            }
            else
            {
                availableUnits = Units.LengthUnits.Values
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                UnitLength newUnit = comboBox.SelectedItem as UnitLength;
                ...
                {
                    decimal? convertedValue = Units.ConvertLength(valueToConvert.Value, currentUnit, newUnit);
