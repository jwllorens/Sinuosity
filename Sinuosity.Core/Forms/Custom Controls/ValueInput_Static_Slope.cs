...
{
    [ToolboxItem(true)]
    public class ValueInput_Static_Slope : Control
    {
        ...
        public ValueInput_Static_Slope()
        {
            textBox = new TextBox
            {
            ...
            if (!string.IsNullOrEmpty(unitString) && Units.GetUnits<UnitSlope>().TryGetValue(unitString, out UnitSlope value))
            {
                currentUnit = value;
            }
            else
