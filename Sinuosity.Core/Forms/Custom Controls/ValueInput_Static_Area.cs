...
{
    [ToolboxItem(true)]
    public class ValueInput_Static_Area : Control
    {
        ...
        public ValueInput_Static_Area()
        {
            ...
            if (!string.IsNullOrEmpty(unitString) && Units.GetUnits<UnitArea>().TryGetValue(unitString, out UnitArea value))
            {
                currentUnit = value;
            }
            else
