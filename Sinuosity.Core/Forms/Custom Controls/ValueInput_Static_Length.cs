...
{
    [ToolboxItem(true)]
    public class ValueInput_Static_Length : Control
    {
        ...
        public string UnitString
        {
            ...
            {
                unitString = value;
                currentUnit = Units.GetUnits<UnitLength>().TryGetValue(unitString, out UnitLength u) ? u : null;
            }
        }
        [Category("Appearance")]
        ...
        public ValueInput_Static_Length()
        {
            textBox = new TextBox
            {
            ...
            if (!string.IsNullOrEmpty(unitString) && Units.GetUnits<UnitLength>().TryGetValue(unitString, out UnitLength value))
            {
                currentUnit = value;
            }
            else
