...
{
    [ToolboxItem(true)]
    public class ValueInput_Variable_Slope : Control
    {
        ...
        private UnitSlope currentUnit = null;
        private UnitSlope[] availableUnits;
        ...
        public ValueInput_Variable_Slope()
        {
            textBox = new TextBox
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            currentUnit = (UnitSlope)comboBox.SelectedItem;
        }
        ...
        public UnitSlope Unit
        {
            get => !DesignMode ? (UnitSlope)comboBox.SelectedItem : null;
            set => SetUnit(value);
        }
        public void SetUnit(UnitSlope unit)
        {
            ...
            UnitSlope foundUnit = availableUnits.FirstOrDefault(u => u.ToString() == unit.ToString());
            if (foundUnit != null)
            {
                suppressSelectedIndexChanged = true;
        ...
        private void UpdateAvailableUnits()
        {
            ...
            {
                availableUnits = Units.SlopeUnits.Values.ToArray();
            }
            else
            {
                availableUnits = Units.SlopeUnits.Values
        ...
        private void ComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                UnitSlope newUnit = comboBox.SelectedItem as UnitSlope;
                ...
                {
                    decimal? convertedValue = Units.ConvertSlope(valueToConvert.Value, currentUnit, newUnit);
