...
namespace PipeHandler
{
        ...
        where T : System.IO.Pipes.PipeStream
    {
        ...
        public async Task SendCommandRequest(string id, string command, string[] arguments)
        {
        ...
        public async Task SendCommandResponse(string id, string command, string status, string message)
        {
        ...
        public async Task SendCommandProgress(string id, string command, int progress, int total, string message)
        {
        ...
        public async Task SendCommandResult(string id, string command, string status, object result, string message)
        {
        ...
        public async Task SendGenericMessage(string id, string message)
        {
        ...
        public void LogCommandRequest(CommandRequest message, string logBase)
        {
            ...
            if (!(string.IsNullOrEmpty(message.Id))) logstring += $"\r\n\tID = {message.Id}";
            if (!(message.Arguments == null)) logstring += $"\r\n\tArguments = {string.Join(", ", message.Arguments)}";
            logstring += "\r\n";
